...
$req_user_info->execute(array($id_user));
														...
														<tr>
															<td>
																<div
																	...
																	<p style="margin: 0;">Nous sommes ravis que vous ayez décider de nous rejoindre dans cette aventure !! <br>
																	Toute l'équipe de One More Training vous remercie et vous souhaite la bienvenue !
																</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td>
																<div
																	style="color:#000000;font-size:14px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;">
																	<p style="margin: 0;">Vous pouvez télécharger votre facture en cliquant sur le boutton ci-dessous :<br>
																</p>
																</div>
															</td>
														</tr>
															...
															<td>
																<div align="center">
																	<td align='center' style='border-radius: 3px;' bgcolor='#FFA73B'>
																		<a href='<?= checkhost().$_SERVER['HTTP_HOST']?>/payment/facture.php?id=<?= $id_user?>' target='_blank' align='center' style='font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 10px 10px; border-radius: 2px; display: inline-block;'>Confirmer votre email</a>
																	</td>
																</div>
															</td>
														</tr>
															...
															<td>
																<div
																	...
																	<p style="margin: 0;">Si cela ne fonctionne pas,
																		...
																		href='<?= checkhost().$_SERVER['HTTP_HOST']?>/payment/facture.php?id=<?= $id_user?>'><?= checkhost().$_SERVER['HTTP_HOST']?>/payment/facture.php?id=<?= $id_user?>
																	</a></p>
																</div>
															</td>
														</tr>
