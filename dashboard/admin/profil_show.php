...
/*     if($user_info['permissions_level'] != 1){
    ...
    $req_user_permissions->execute(array($id_user));
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><a href="../admin/index.php"><i class="fa-solid fa-arrow-left"></i></a> Profil de <?=$user_info['firstname'].' '.$user_info['surname']?></h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Informations Utilisateurs</li>
                    </ol>
                    <div class="alert alert-danger" role="alert">
                        <h4 class="alert-heading">Attention !</h4>
                        <p>Cette page est une prévisualisation seulement! Aucune modification sera appliqué! <a href="../admin/index.php">Revenir au pannel d'administration</a></p>
                    </div>
                    <?php 
                        ...
                        <div class="col-xl-9 col-md-9 d-flex align-items-stretch">
                            <div class="card bg-light mb-4 w-100">
                                <div class="card-body">
                                    ...
                                    <a class="text-info float-end" href="/ajax/get_user_information_file.php?id_user=<?=$id_user?>"><i class="fa-solid fa-download"></i></a>
                                    </p>
                                    <hr>
                            ...
                            <div class="card bg-light mb-4 w-100">
                                <div class="card-body">
                                    ...
                                    <?php 
                                        ...
                                        $req_id_user_badge->execute(array($id_user));
                            ...
                            <div class="card bg-light mb-4 w-100">
                                <div class="card-body">
                                    ...
                                    <?php 
                                        ...
                                        $req_objective->execute(array($id_user));
                            ...
                            <div class="card bg-light mb-4 w-100">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        $get_users_group->execute(array($id_user));
