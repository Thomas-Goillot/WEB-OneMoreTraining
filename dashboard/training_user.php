    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-sm">
                                    ...
                                    $get_training = $bdd->prepare('SELECT id_training,name_training,privacy_training,creation_date,firstname,surname,TRAINING.id_user 
                                    FROM TRAINING,OMT_USER 
                                    WHERE TRAINING.id_user = OMT_USER.id_user AND TRAINING.id_user = ?
                                    ...
                                    while($donnees = $get_training->fetch()){
                                        ...
                                        echo '<td>
                                        <a href="../training.php?id_training='.$donnees['id_training'].'" class="btn btn-link text-success"><i class="fa-solid fa-play"></i></a>
                                        <a href="edit_training_user.php?id='.$donnees['id_training'].'" class="btn btn-link text-dark"><i class="fa-solid fa-pen-to-square"></i></a>
            ...
            <div id="scripttoreload">
                <script src="/dashboard/assets/js/training_user.js"></script>
            </div>
